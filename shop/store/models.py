...
class Product(models.Model):
    ...
    quantity = models.PositiveIntegerField(default=10, verbose_name='Кол-во')
    price = models.IntegerField(verbose_name='Стоимость')
    sku = models.CharField(max_length=50, verbose_name='Артикул')
    preview = models.ImageField(verbose_name='Заставка', upload_to='')
    condition = models.CharField(max_length=10, choices=ProductOptionChoices.choices, verbose_name='Состояние',
                                 blank=True)
...
class Review(models.Model):
    ...
    author = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='reviews', verbose_name='Author')
